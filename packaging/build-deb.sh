...
mkdir -p "$STAGE/DEBIAN" "$STAGE/usr/lib/agent-hub/bin" "$STAGE/usr/bin" "$STAGE/lib/systemd/system" "$STAGE/usr/share/applications" "$STAGE/usr/share/icons/hicolor/scalable/apps"
...
install -m 0644 "$ROOT/packaging/debian/icons/agent-hub.svg" "$STAGE/usr/share/icons/hicolor/scalable/apps/agent-hub.svg"
